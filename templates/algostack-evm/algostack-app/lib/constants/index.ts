...
export const HOME_DOMAIN =
  process.env.NEXT_PUBLIC_VERCEL_ENV === 'production'
    ? 'https://algostack-evm.vercel.app'
...
export const API_DOMAIN =
  process.env.NEXT_PUBLIC_VERCEL_ENV === 'production'
    ? 'https://api.algostack-evm.vercel.app'
    : process.env.NEXT_PUBLIC_VERCEL_ENV === 'preview'
...
export const SIWA_DOMAINS = [
  {
    slug: 'algostack-evm.vercel.app',
    verified: true,
    primary: true,
    target: 'https://algostack-evm.vercel.app',
    type: 'redirect',
    placeholder: 'https://algostack-evm.vercel.app',
    allowedHostnames: [],
  },
];
