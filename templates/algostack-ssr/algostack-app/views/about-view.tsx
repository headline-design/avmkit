          ...
          <div className="flex flex-col items-center justify-center space-y-4 text-center">
            <div className="space-y-2">
              ...
              <p className="max-w-[800px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                A single template that combines the best features of Algorand
                and Create Next App. AlgoStack SSR provides a seamless development
                experience with built-in features for enhanced developer
                productivity, optimized performance, and seamless integration
                with Next.js.
              </p>
            </div>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-2 lg:gap-10">
            <div className="space-y-4">
              ...
              <p className="max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                AlgoStack SSR comes with a simple setup process, allowing you to
            ...
            <div className="space-y-4">
              ...
              <p className="max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                With AlgoStack SSR, you get a performant web application out of
                the box. The template is optimized for speed, with features like
            ...
            <div className="space-y-4">
              ...
              <p className="max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                AlgoStack SSR is designed to work seamlessly with Next.js, the
            ...
            <div className="space-y-4">
              ...
              <p className="max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                AlgoStack SSR provides a set of tools and utilities to
                streamline the development process. With features like hot
                module replacement, integrated testing, and a component library,
                you can iterate quickly, catch errors early, and maintain a
