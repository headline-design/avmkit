...
export const API_DOMAIN =
  process.env.NEXT_PUBLIC_VERCEL_ENV === 'production'
    ? 'https://api.algostack-ssr.siwa.org'
    : process.env.NEXT_PUBLIC_VERCEL_ENV === 'preview'
...
export const SIWA_DOMAINS = [
  {
    slug: 'algostack-ssr.siwa.org',
    verified: true,
    primary: true,
    target: 'https://algostack-ssr.siwa.org',
    type: 'redirect',
    placeholder: 'https://algostack-ssr.siwa.org',
    allowedHostnames: [],
  },
];
