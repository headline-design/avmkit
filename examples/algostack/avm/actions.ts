...
export type Config = {
  ...
  state: {
    connections: Map<
      string,
      { accounts: readonly Address[]; chainId: number; connector: Connector }
    >;
...
export function getAccount<config extends Config>(config: config): GetAccountReturnType<config> {
