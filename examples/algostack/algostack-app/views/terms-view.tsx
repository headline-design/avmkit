      ...
      <div className="container flex flex-col items-center justify-center min-h-screen py-12 space-y-4 text-center md:py-24 lg:space-y-8">
        ...
        <div className="grid gap-6 px-4 text-left md:px-6 lg:gap-10 xl:gap-12">
          ...
          <div className="mx-auto prose max-w-5xl lg:prose-lg xl:prose-xl dark:prose-invert">
            ...
            <p>
              If you are given an account, you are responsible for maintaining
            ...
            <p>
              We, the owner of this website, will not be held responsible for
              any damages that may occur, including but not limited to direct,
              indirect, special, incidental, consequential, or punitive damages.
            </p>
            <h2 className="text-2xl font-bold">Changes to Terms</h2>
            <p>
              We reserve the right to make changes to our site, policies, and
              these terms of use at any time. If any of these conditions shall
