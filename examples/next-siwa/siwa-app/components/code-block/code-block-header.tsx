...
export const CodeBlockHeader = ({
  ...
  return (
    <div className={styles.codeBlock_header}>
      <div className={styles.codeBlock_fileName}>
        <div aria-hidden="true" className={styles.codeBlock_iconWrapper}>
          <svg
            fill="none"
            height={14}
            viewBox="0 0 512 512"
        ...
        <span className={styles.codeBlock_filename}>{fileLocation}</span>
      </div>
      <div className={styles.codeBlock_actions}>
        <Button
          size="sm"
          className={styles.codeBlock_copyButton}
          variant={"ghost"}
          onClick={() => handleCopy(code, "install")}
        >
