          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <p className="text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                SIWA offers a seamless setup process, combining the best
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                SIWA leverages the power of Next.js, a popular React
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                With SIWA, you have access to the extensive React
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                SIWA comes pre-configured with Tailwind CSS, a
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                SIWA supports HMR, allowing developers to see instant
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                SIWA optimizes the build process, ensuring that the
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                SIWA provides a variety of customizable templates to
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                SIWA integrates with popular developer tools such as
            ...
            <div className="space-y-2">
              ...
              <p className="text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                SIWA offers comprehensive documentation and support
