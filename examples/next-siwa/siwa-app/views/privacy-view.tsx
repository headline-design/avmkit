        ...
        <div className="container px-4 md:px-6">
          <div className="mx-auto prose max-w-5xl lg:prose-lg xl:prose-xl dark:prose-invert">
            <div className="space-y-4">
              ...
              <p>
                The SIWA app respects your privacy and is committed to protecting your personal data. This privacy
            ...
            <div className="space-y-8">
              <section>
                ...
                <p>
                  The SIWA app may collect personal information provided by users, such as names, email addresses,
              ...
              <section>
                ...
                <p>
                  The SIWA app employs security measures to protect user data, including encryption of data
              ...
              <section>
                ...
                <p>
                  The SIWA app uses cookies to enhance the user experience and provide personalized features. Users
