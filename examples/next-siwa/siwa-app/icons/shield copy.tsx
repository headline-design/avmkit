const IconShield = ({className} : {
    ...
    <>
      <svg id="Layer_1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" height={20} width={20}
       style={{color: "var(--ds-teal-600)"}}
      className={className}>
        <rect
        ...
        <rect
          ...
          strokeWidth={0}
        />
        <rect x={5} y="5.5" width={13} height="3.5" fill="currentColor" strokeWidth={0} />
      </svg>
    </>
  )
