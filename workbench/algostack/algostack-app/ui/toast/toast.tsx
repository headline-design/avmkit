...
export function toast(message) {
  return sonnerToast.custom(
    (t) => <DefaultToast message={message} dismiss={() => sonnerToast.dismiss(t as number)} />,
    { duration: 5000 },
  );
}
...
toast.success = (message) =>
  sonnerToast.custom(
    (t) => <SuccessToast message={message} dismiss={() => sonnerToast.dismiss(t as number)} />,
    { duration: 5000 },
  );

toast.error = (message) =>
  sonnerToast.custom(
    (t) => <ErrorToast message={message} dismiss={() => sonnerToast.dismiss(t as number)} />,
    { duration: 5000 },
  );

toast.warning = (message) =>
  sonnerToast.custom(
    (t) => <WarningToast message={message} dismiss={() => sonnerToast.dismiss(t as number)} />,
    { duration: 5000 },
  );
