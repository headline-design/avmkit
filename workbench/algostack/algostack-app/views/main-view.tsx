...
import NetworkSettings from "../components/network-settings/network-settings";
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 border-t border-b">
          <div className="container grid items-center gap-6 px-4 md:px-6">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              <div className="w-full flex flex-col items-center justify-center space-y-4 text-center border rounded p-4">
                <h3 className="text-xl font-bold">Opt-in to asset</h3>
                <Button
                  className="w-full"
                  onClick={async () => {
                    await Pipeline.send(
                ...
                >
                  Opt-in to asset (testnet)
                </Button>
              </div>
              <div className="w-full flex flex-col items-center justify-center space-y-4 text-center border rounded p-4">
                <h3 className="text-xl font-bold">Opt-in to app</h3>

                <Button
                  className="w-full"
                  onClick={() => Pipeline.optIn(1136066393, ["register"])}
                >
                  Opt-in to app (mainnet)
                </Button>
                <Button
                  className="w-full"
                  onClick={() => Pipeline.optIn(222917185, ["register"])}
                >
                  Opt-in to app (testnet)
                </Button>
              </div>
            </div>
            <div className="grid gap-6 md:grid-cols-2">
              Transactions
              <div className="w-full flex flex-col items-center justify-center space-y-4 text-center border rounded p-4">
                <h3 className="text-xl font-bold">Send asset</h3>
                <Button
                  className="w-full"
                  onClick={async () => {
                    await Pipeline.send(
