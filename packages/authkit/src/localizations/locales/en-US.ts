...
const enUS: LocaleProps = {
  ...
  signInWithAlgorandScreen_signedOut_heading: 'Sign In With Ethereum',
  signInWithAlgorandScreen_signedOut_h1:
    'This app would like to verify you \n as the owner of this wallet.',
  signInWithAlgorandScreen_signedOut_p: `Please sign the message request \n in your wallet to continue.`,
  signInWithAlgorandScreen_signedOut_button: 'Sign In',

  signInWithAlgorandScreen_signedIn_heading: 'Signed In With Ethereum',
  signInWithAlgorandScreen_signedIn_h1:
    'You successfully verified yourself \n as the owner of this wallet.',
  signInWithAlgorandScreen_signedIn_p: `Signing out will require you to \n authenticate again in the future.`,
  signInWithAlgorandScreen_signedIn_button: 'Sign Out',
};
