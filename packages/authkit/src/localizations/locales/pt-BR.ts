...
const ptBR: LocaleProps = {
  ...
  signInWithAlgorandScreen_tooltip: 'Você não está conectado a este aplicativo.\n**Entre com Ethereum** para continuar.',
  signInWithAlgorandScreen_signedOut_heading: 'Entrar com Ethereum',
  signInWithAlgorandScreen_signedOut_h1: 'Este aplicativo gostaria de verificar você \n como o proprietário desta carteira.',
  signInWithAlgorandScreen_signedOut_p: `Por favor, assine o pedido de mensagem \n em sua carteira para continuar.`,
  signInWithAlgorandScreen_signedOut_button: 'Entrar',

  signInWithAlgorandScreen_signedIn_heading: 'Conectado com Ethereum',
  signInWithAlgorandScreen_signedIn_h1: 'Você se verificou com sucesso \n como o proprietário desta carteira',
  signInWithAlgorandScreen_signedIn_p: `Se sair, será necessário que você \n autentique novamente no futuro.`,
  signInWithAlgorandScreen_signedIn_button: 'Sair'
};
