...
const esES: LocaleProps = {
  ...
  signInWithAlgorandScreen_signedOut_heading: 'Inicia sesión con Ethereum',
  signInWithAlgorandScreen_signedOut_h1:
    'Esta aplicación desea verificar que eres el propietario de esta cartera.',
  signInWithAlgorandScreen_signedOut_p: `Firma la solicitud de mensaje en tu cartera para continuar.`,
  signInWithAlgorandScreen_signedOut_button: 'Iniciar sesión',

  signInWithAlgorandScreen_signedIn_heading: 'Sesión iniciada con Ethereum',
  signInWithAlgorandScreen_signedIn_h1:
    'Te has verificado correctamente como propietario de esta cartera.',
  signInWithAlgorandScreen_signedIn_p: `Si cierras la sesión, tendrás que volver a autenticarte más adelante.`,
  signInWithAlgorandScreen_signedIn_button: 'Cerrar sesión',
};
