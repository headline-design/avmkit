export default {
  ...
  signInWithAlgorandScreen_signedOut_heading: 'イーサリアムでサインイン',
  signInWithAlgorandScreen_signedOut_h1:
    'このアプリは、あなたがこのウォレットの 所有者であることを確認しようとしています。',
  signInWithAlgorandScreen_signedOut_p: `続行するには、ウォレットで メッセージ リクエストに署名してください。`,
  signInWithAlgorandScreen_signedOut_button: 'サインイン',

  signInWithAlgorandScreen_signedIn_heading: 'イーサリアムでサインインしました',
  signInWithAlgorandScreen_signedIn_h1:
    'このウォレットの所有者であることが 正常に確認されました。',
  signInWithAlgorandScreen_signedIn_p: `サインアウトすると、今後 再度認証する必要があります。`,
  signInWithAlgorandScreen_signedIn_button: 'サインアウト',
};
