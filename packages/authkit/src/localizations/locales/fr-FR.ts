...
const frFR: LocaleProps = {
  ...
  signInWithAlgorandScreen_tooltip:
    'Vous n’êtes pas connecté à cette application.\n**Connectez-vous avec Ethereum** pour continuer.',
  signInWithAlgorandScreen_signedOut_heading: 'Connectez-vous avec Ethereum',
  signInWithAlgorandScreen_signedOut_h1:
    'Cette application souhaite vérifier que vous êtes bien le propriétaire de ce portefeuille.',
  signInWithAlgorandScreen_signedOut_p: `Veuillez signer la demande de message dans votre portefeuille pour continuer.`,
  signInWithAlgorandScreen_signedOut_button: 'Se connecter',

  signInWithAlgorandScreen_signedIn_heading: 'Connecté avec Ethereum',
  signInWithAlgorandScreen_signedIn_h1:
    'Vous avez réussi à vous identifier en tant que propriétaire de ce portefeuille.',
  signInWithAlgorandScreen_signedIn_p: `La déconnexion vous obligera à vous authentifier à nouveau à l'avenir.`,
  signInWithAlgorandScreen_signedIn_button: 'Se déconnecter',
};
