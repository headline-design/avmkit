...
const zhCN: LocaleProps = {
  ...
  signInWithAlgorandScreen_tooltip:
    '您尚未登录到此应用。\n请选择**使用以太坊登录**以继续。',
  signInWithAlgorandScreen_signedOut_heading: '使用以太坊登录',
  signInWithAlgorandScreen_signedOut_h1: '此应用希望验证您是 此钱包的所有者。',
  signInWithAlgorandScreen_signedOut_p: `请签署钱包中的消息请求 以继续。`,
  signInWithAlgorandScreen_signedOut_button: '登录',

  signInWithAlgorandScreen_signedIn_heading: '已使用以太坊登录',
  signInWithAlgorandScreen_signedIn_h1: '您已成功验证自己 是此钱包的所有者。',
  signInWithAlgorandScreen_signedIn_p: `登出后，将来您还需要 再次进行身份验证。`,
  signInWithAlgorandScreen_signedIn_button: '登出',
};
